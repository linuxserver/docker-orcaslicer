...
<!-- Please read https://github.com/linuxserver/docker-orcaslicer/blob/main/.github/CONTRIBUTING.md -->
...
| Parameter | Function |
| :----: | --- |
| `-p 3000` | Orca Slicer desktop gui. |
| `-p 3001` | Orca Slicer desktop gui HTTPS. |
